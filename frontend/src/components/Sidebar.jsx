...
import { Lightbulb, Menu, SidebarClose, Sparkles, X } from 'lucide-react';
            ...
            <div className={TIP_CARD.container}>
              <div className=' flex items-center gap-2'>
                ...
                <div>
                  ...
                  <a href='https://www.linkedin.com/in/abhishekkmalviya/' target='_blank' className=' block mt-2 text-sm text-purple-500 hover:underline'>
                    If you see this, Please drop a message to my linkedin to show love:) </a>
                </div>
              </div>
            </div>
          </div>
